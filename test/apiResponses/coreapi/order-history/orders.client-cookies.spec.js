...
import {
  loginAndGetOrderHistoryWithCookies,
  getOrderDetailsForAllOfOrderHistoryCookies,
  ...
  describe('Order History Schema', () => {
    ...
    beforeAll(async () => {
      try {
        ...
        } = await loginAndGetOrderHistoryWithCookies())
      } catch (error) {
    ...
    beforeAll(async () => {
      try {
        ;({
          historyDetails,
          response,
        } = await getOrderDetailsForAllOfOrderHistoryCookies())
      } catch (error) {
        throw path(['response', 'error', 'text'], error)
          ? new Error(error.response.error.text)
          : error
