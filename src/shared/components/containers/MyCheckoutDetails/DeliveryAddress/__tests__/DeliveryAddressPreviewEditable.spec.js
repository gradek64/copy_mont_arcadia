...
import DeliveryAddressPreviewEditable from '../DeliveryAddressPreviewEditable'
...
const renderComponent = testComponentHelper(
  DeliveryAddressPreviewEditable.WrappedComponent
)

describe('<DeliveryAddressPreviewEditable />', () => {
  describe('@renders', () => {
  ...
  describe('mapDispatchToProps', () => {
    it('onEnableEditingClick handler is wired into props correctly', () => {
      ...
      const { instance, store } = renderComponent({
        scrollSelector: '#test-element-selector-delivery',
        user: {
          creditCard: {},
        },
      })
      ...
      expect(store.getActions()).toEqual(
        expect.arrayContaining([
          ...
          },
          {
            ...
            initialFocus: '#test-element-selector-delivery',
          },
        ])
      )
